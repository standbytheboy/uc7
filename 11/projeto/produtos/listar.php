            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="produto-delete.php?id=<?php echo htmlspecialchars($produto->getId()); ?>" class="delete-button" onclick="return confirm('Tem certeza que deseja excluir este produto?');">Excluir</a>
                    </td>
                </tr>
            <?php
            }
